...
extern const MIDL_SERVER_INFO IMathATL_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IMathATL_ProxyInfo;
...
/* Object interface: IMathATL, ver. 0.0,
   GUID={0x0584da83,0xb7dc,0x4e1e,{0xb4,0x25,0x26,0x54,0xcc,0x6e,0x34,0x2a}} */

#pragma code_seg(".orpc")
static const unsigned short IMathATL_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IMathATL_ProxyInfo =
    ...
    &IMathATL_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IMathATL_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    AutoSvr__MIDL_ProcFormatString.Format,
...
static const PRPC_STUB_FUNCTION IMathATL_table[] =
{
...
{
    ( CInterfaceProxyVtbl *) &_IMathATLProxyVtbl,
    0
};
