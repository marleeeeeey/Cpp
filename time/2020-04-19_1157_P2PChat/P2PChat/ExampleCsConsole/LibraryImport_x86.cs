...
namespace ExampleCsConsole
{
    ...
    {
        [DllImport("ExampleCppLib_x86", CallingConvention = CallingConvention.StdCall, ExactSpelling = false, EntryPoint = "_SetReceiveMessageCallBack@4")]
        private static extern void SetReceiveMessageCallBackInternal(OnReceiveMessageCallBack cb);

        [DllImport("ExampleCppLib_x86", CallingConvention = CallingConvention.StdCall, ExactSpelling = false, EntryPoint = "_StartCore@0")]
        private static extern void StartCoreInternal();

        [DllImport("ExampleCppLib_x86", CallingConvention = CallingConvention.StdCall, ExactSpelling = false, EntryPoint = "_SendMsg@4")]
