...
int main()
{
    ...
    AVAR(sBackground.getGlobalBounds().width);
    AVAR(sBackground.getGlobalBounds().height);
    AVAR(sBackground.getLocalBounds().width);
    AVAR(sBackground.getLocalBounds().height);
